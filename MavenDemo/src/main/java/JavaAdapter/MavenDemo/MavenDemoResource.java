...
@Path("/resource")
public class MavenDemoResource {
	/*
	...
	static Logger logger = Logger.getLogger(MavenDemoResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource/greet/{name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenDemo/resource/protected"
	 */
